      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="#"  class="menu-toggle nav-link has-dropdown"><i data-feather="layout"></i><span>Courses</span></a>
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="add_course.php" id="loadDashboard">Add Courses</a></li>
              </ul>
            </li>
          </ul>
        </aside>
