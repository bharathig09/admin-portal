...
$name = $_SESSION["admin_name"];
    ...
    $qry = mysqli_query($conn, "INSERT INTO courses (course_name, course_description, course_image, course_share_image, course_banner_image, course_share_desc, related_courses, instructor_id, iframe_url, lessons, students, created_by) VALUES ('$courseName', '$courseDescription', '$imageURL','$shareImage', '$bannerImage', '$courseDescription', '$relatedCourses', '$instructor', '$iframe_url', '$lessons', '$students', '$name')") or die(mysqli_error($conn));
