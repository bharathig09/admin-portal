        ...
        <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data" id="formData">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="about_instructor" name="about_instructor" rows="4" required></textarea>
                </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="instructor_designation" name="instructor_designation" required>
                </div>
                </div>
