...
$sql = "INSERT INTO current_opening (course_name, no_of_openings, hiring, status, created_by, modified_by) VALUES (?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sisiss", $course_name, $no_of_openings, $hiring, $status, $created_by, $modified_by);
    $stmt->execute();
    ...
    <div class="main-content" style="min-height: 647px;">
        <section class="section">
            ...
            <input type="text" class="form-control" id="course_id" name="course_id" readonly>
                                        ...
                                        <div class="form-group">
                                        <label for="no_of_openings">No of Openings:<span style="color: red;">*</span></label>
                                        ...
                                        <input type="text" class="form-control" id="hiring" name="hiring" required>
                                        </div>
                                        <div class="form-group">
                    ...
                    $(".deleteBtn").click(function () {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                $.post("current_open__dr.php", { course_id: id }, function (data) {
                                    Swal.fire(
                                        'Deleted!',
