                ...
                <div class="modal-body">
                    <form action="bootcampdb.php" id="editForm" method="post">
                        ...
                        <div class="form-group">
                                            ...
                                            <input value="<?php echo $_SESSION['admin_name']?>" readonly class="form-control" id="modified_by" name="modified_by">
                                        </div>
                </div>
    ...
    $(document).ready(function () {
        $('.submitBtn').click(function (e) {
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo "<button  class= 'edit btn'  id='" . $row['bootcamp_id'] . "'><i class='far fa-edit'></i>Update</button>";
                
                echo "<div class='dropdown-divider'></div>";
                echo "<button type='button' class='btn deleteBtn' data-id='" . $row['bootcamp_id'] . "'><i class='far fa-trash-alt'></i>Delete</button>";
                echo "</div>";
                echo "</div>";
                echo "</td>";
