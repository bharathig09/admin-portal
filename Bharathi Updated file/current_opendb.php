...
$sql = "INSERT INTO current_opening (co_id, course_name, no_of_openings, hiring, status, created_by, modified_by) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="current_opendb.php.php" id="editForm" method="post">
                    <!-- Your form fields go here -->
                    <input type="hidden" name="snoEdit" id="snoEdit">
                    <div class="form-group">
                        <label for="course_name" required>Course Name:<span style="color: red;">*</span></label>
                    ...
                    <div class="form-group" style="display: none;">
                        ...
                        <input type="text" class="form-control" id="course_name_input" name="course_name_input"
                            readonly>
                    </div>
                    <div class="form-group">
    ...
    <section class="section">
        ...
        <div class="section-body">
                                ...
                                <form action="current_opendb.php" id="addRecordForm" method="post">
                                    <div class="row">
                                        ...
                                        ?>
                                            ...
                                            <div class="form-group">
                                                <label for="created_by">Created By:</label>
                                                <input value="<?php echo $_SESSION['admin_name']?>" readonly
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label for="hiring">Hiring:<span style="color: red;">*</span></label>
                                                <input type="text" class="form-control" id="hiring" name="hiring"
                                                    required>
                                            </div>
                                            <div class="form-group">
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo "<button  class= 'edit btn'  id='" . $row['co_id'] . "'><i class='far fa-edit'></i>Update</button>";
                
                echo "<div class='dropdown-divider'></div>";
                echo "<button type='button' class='btn deleteBtn' data-id='" . $row['co_id'] . "'><i class='far fa-trash-alt'></i>Delete</button>";
                echo "</div>";
                echo "</div>";
                echo "</td>";
                // echo '<td><button  class= "edit btn btn btn-primary"  id="' . $row['co_id'] . '">Edit</button>';
                // echo '<button type="button" class="btn btn-danger deleteBtn" data-id="' . $row["co_id"] . '">Delete</button></td>';
                echo "</tr>";
              }
            $conn->close();
            ?>
