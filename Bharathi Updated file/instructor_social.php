...
$(document).ready(function () {
    $("#formData").submit(function (event) {
        ...
        $.ajax({
            url: "http://localhost/admin_template/instructor_social-insert.php",
            type: "POST",
    ...
    $('#myTable').on('click', '.deleteBtn', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "http://localhost/admin_template/instructor_social-delete.php",
                        type: "POST",
                        data: {
                            action: 'delete',
    ...
    function fetch() {
        $.ajax({
            url: "http://localhost/admin_template/instructor_social-select.php",
            type: "GET",
