...
$(document).ready(function () {
    ...
    $("#coursecurriculum").submit(function (e) {
        ...
        var technologyDetails = $('#technology_details').val();
        var technology = $('#technology').val();
        var trainingTime = $('#training_time').val();
        var practiceTime = $('#practice_time').val();

        if (!dayNo || !technologyDetails || !technology || !trainingTime || !practiceTime) {
            Swal.fire({
                icon: 'error',
