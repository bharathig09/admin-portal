                ...
                <div class="modal-body">
                    <form action="bootcampdb.php" id="editForm" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input value="<?php echo $_SESSION['admin_name']?>" class="form-control" id="modified_by"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <?php
                                $tag_qry=mysqli_query($conn,"select tag_id,tag_name from tags where status='1'") or die(mysqli_error($conn));
                                while($res=mysqli_fetch_object($tag_qry)){
                                    ?>
                                <option value="<?php echo $res -> tag_id?>"><?php echo $res -> tag_name?></option>
                                <?php
                                }
                                ?>
                            </select>
                                ...
                                <?php
                                $menu_qry=mysqli_query($conn,"select menu_id,menu_name from menus where status='1' AND parent_id!='0'") or die(mysqli_error($conn));
                                while($res=mysqli_fetch_object($menu_qry)){
                                    ?>
                                <option value="<?php echo $res -> menu_id?>"><?php echo $res -> menu_name?></option>
                                <?php
                                }
                                ?>
                            </select>
    ...
    $(document).ready(function () {
        $('.submitBtn').click(function (e) {
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo "<button  class= 'edit btn'  id='" . $row['meta_id'] . "'><i class='far fa-edit'></i>Update</button>";
                
                echo "<div class='dropdown-divider'></div>";
                echo "<button type='button' class='btn deleteBtn' data-id='" . $row['meta_id'] . "'><i class='far fa-trash-alt'></i>Delete</button>";
                echo "</div>";
                echo "</div>";
                echo "</td>";
