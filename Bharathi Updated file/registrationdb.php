        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input value="<?php echo $_SESSION['admin_name']?>" readonly class="form-control" id="created_by" name="created_by">
                </div>
                <div class="form-group">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table" id="myTable">
                ...
                echo "<button  class= 'edit btn'  id='" . $row['student_id'] . "'><i class='far fa-edit'></i>Update</button>";
                
                echo "<div class='dropdown-divider'></div>";
                echo "<button type='button' class='btn deleteBtn' data-id='" . $row['student_id'] . "'><i class='far fa-trash-alt'></i>Delete</button>";
                echo "</div>";
                echo "</div>";
                echo "</td>";
