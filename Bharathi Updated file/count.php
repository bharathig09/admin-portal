...
$(document).ready(function () {
    $("#formData").submit(function (event) {
        ...
        $.ajax({
            url: "http://localhost/admin_template/count-insert.php",
            type: "POST",
    ...
    $('#myTable').on('click', '.deleteBtn', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "http://localhost/admin_template/count-delete.php",
                        type: "POST",
                        data: {
                            action: 'delete',
                            hid: count_id
    ...
    function fetch() {
        $.ajax({
            url: "http://localhost/admin_template/count-select.php",
            type: "GET",
